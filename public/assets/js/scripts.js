...
var scrollTop = $(window).scrollTop();
	...
	if (scrollTop > 200) {
		...
		var purchaseTop = $('.purchase')[0].getBoundingClientRect().top;
		var detailTop = $('.detail')[0].getBoundingClientRect().top;
		var featuresTop = $('.features')[0].getBoundingClientRect().top;
		var getItTop = $('.get-it')[0].getBoundingClientRect().top;
		// if(purchaseTop >= 0){
		// 	$('.navbar-nav li').removeClass('active');
		// 	$('#purchaseTop').addClass('active');
		// }
		// if(detailTop >= 0){
		// 	$('.navbar-nav li').removeClass('active');
		// 	$('#detailTop').addClass('active');
		// }
		// if(featuresTop >= 0){
		// 	$('.navbar-nav li').removeClass('active');
		// 	$('#featuresTop').addClass('active');
		// }
		// if(getItTop >= 0){
		// 	$('.navbar-nav li').removeClass('active');
		// 	$('#getItTop').addClass('active');
		// }
		//
